...
const web3 = new Web3(process.env.GANACHE_URL || 'http://10.71.39.50:8545');  // Change 'localhost' to the correct address if in Docker.
...
const interact = async () => {
    try {
        ...
        const tx = await contract.methods.storeData(53).send({ from: accounts[0], gas: 3000000 });
